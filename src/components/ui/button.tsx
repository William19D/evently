...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-soft hover:shadow-elegant hover:scale-105",
        destructive:
        ...
        hero: "bg-gradient-hero text-white shadow-elegant hover:shadow-card hover:scale-105 font-semibold",
        premium: "bg-accent text-accent-foreground shadow-card hover:shadow-elegant hover:scale-105 border border-primary/20"
      },
      size: {
